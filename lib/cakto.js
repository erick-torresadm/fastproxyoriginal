...
console.log('CAKTO_LIB loaded successfully');
...
const Cakto = {
  ...
  async createCheckout(checkoutData) {
    console.log('Cakto.createCheckout called with:', JSON.stringify(checkoutData, null, 2));
    const result = await caktoRequest('POST', '/public_api/checkouts/', checkoutData);
    console.log('Cakto.createCheckout result:', JSON.stringify(result, null, 2));
    return result;
  },
