...
async function sendPasswordResetEmail(email, name, resetToken) {
  ...
  const html = `
    ...
    <body style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #0a0a0a; color: #ffffff;">
      <div style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); padding: 30px; border-radius: 15px 15px 0 0; text-align: center;">
        <h1 style="margin: 0; color: white;">🔑 FastProxy</h1>
      </div>
      <div style="background: #1a1a1a; padding: 30px; border-radius: 0 0 15px 15px;">
        <h2 style="color: #60a5fa; margin-top: 0;">Redefinição de senha</h2>
        <p style="color: #a0a0a0; line-height: 1.6;">
          Olá, ${name || 'Cliente'}! Recebemos um pedido para redefinir a senha da sua conta.
        </p>
        <p style="color: #a0a0a0; line-height: 1.6;">
          Clique no botão abaixo para criar uma nova senha. Este link expira em <strong style="color:#fbbf24;">30 minutos</strong>.
        </p>
        ...
        <p style="color: #6b7280; font-size: 13px; line-height: 1.5;">
          Se você não solicitou a redefinição de senha, ignore este email. Sua senha permanece inalterada.
        </p>
      </div>
      <div style="text-align: center; padding: 20px; color: #666; font-size: 12px;">
        <p>Este é um email automático do FastProxy. Não responda esta mensagem.</p>
  ...
  return sendEmail({
    to: email,
    subject: '🔑 Redefinição de senha — FastProxy',
    html
  });
}
